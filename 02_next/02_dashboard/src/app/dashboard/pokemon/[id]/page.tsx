...
export async function generateMetadata({params}: Props):Promise<Metadata>{
    try {
        const { id, name } = await getPokembyId(params.id);
...
const getPokembyId = async (id:string): Promise<PokemonResponse> => {
    try {

        const dataResponswe = await fetch(
        ...
        const pokemonRespose = await dataResponswe.json();
...
export default async function PokemonPage({ params }: Props) {
    ...
    const pokemon = await getPokembyId(params.id);
